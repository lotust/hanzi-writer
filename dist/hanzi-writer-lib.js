...
module.exports = /******/ (function(modules) {
  ...
  /******/ [
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      /* WEBPACK VAR INJECTION */ (function(global) {
        ...
        function colorStringToVals(colorString) {
          ...
          var rgbMatch = normalizedColor.match(
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var animateSingleStroke = function animateSingleStroke(
        charName,
        character,
        strokeNum,
        speed
        ...
        ].concat(animateStroke(charName, character.strokes[strokeNum], speed));
      };
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      /* WEBPACK VAR INJECTION */ (function(global) {
              ...
              .run(
                characterActions.showCharacter(
                  ...
                  typeof options.duration === 'number'
                    ? options.duration
                    : _this._options.strokeFadeDuration
                )
              )
              .then(function(res) {
            ...
            return _this2._renderState
              .run(
                characterActions.hideCharacter(
                  ...
                  typeof options.duration === 'number'
                    ? options.duration
                    : _this2._options.strokeFadeDuration
                )
              )
              .then(function(res) {
                return callIfExists(options.onComplete, res);
        ...
        HanziWriter.prototype.loopCharacterAnimation = function() {
          ...
          this.cancelQuiz();
          return this._withData(function() {
            return _this5._renderState.run(
              characterActions.animateCharacterLoop(
                'main',
                _this5._character,
                _this5._options.strokeFadeDuration,
                _this5._options.strokeAnimationSpeed,
                _this5._options.delayBetweenStrokes,
                _this5._options.delayBetweenLoops
              ),
              { loop: true }
            );
          });
            ...
            return _this7._renderState
              .run(
                characterActions.hideCharacter(
                  ...
                  typeof options.duration === 'number'
                    ? options.duration
                    : _this7._options.strokeFadeDuration
                )
              )
              .then(function(res) {
                return callIfExists(options.onComplete, res);
        ...
        HanziWriter.prototype.updateColor = function(colorName, colorVal) {
          ...
          return this._withData(function() {
            var duration =
              typeof options.duration === 'number'
                ? options.duration
                : _this8._options.strokeFadeDuration;
            ...
            var mutation = characterActions.updateColor(
              colorName,
              mappedColor,
              duration
            );
            ...
            if (colorName === 'radicalColor' && !colorVal) {
              mutation = mutation.concat(
                characterActions.updateColor(colorName, null, 0)
              );
            }
        ...
        HanziWriter.prototype.setCharacter = function(char) {
          ...
          this._withDataPromise = this._loadingManager
            ...
            .then(function(pathStrings) {
              ...
              _this10._character = charDataParser.generateCharacter(
                char,
                pathStrings
              );
              _this10._positioner = new Positioner(_this10._options);
              _this10._hanziWriterRenderer = new HanziWriterRenderer(
                _this10._character,
                _this10._positioner
              );
              _this10._renderState = new RenderState(
                _this10._character,
                _this10._options,
                function(nextState) {
              ...
              _this10._hanziWriterRenderer.mount(
                _this10._canvas,
                _this10._renderState.state
              );
        ...
        HanziWriter.prototype._setupListeners = function() {
          ...
          this._canvas.svg.addEventListener('mousedown', function(evt) {
            ...
            evt.preventDefault();
            _this12._forwardToQuiz(
              'startUserStroke',
              _this12._getMousePoint(evt)
            );
          });
        ...
        HanziWriter.prototype._getMousePoint = function(evt) {
          if (this._pt) {
            ...
            var localPt = this._pt.matrixTransform(
              this._canvas.svg.getScreenCTM().inverse()
            );
          ...
          return {
            ...
            transform: trim(
              '\n      translate(' +
                ...
                ', ' +
                (positioner.getHeight() - positioner.getYOffset()) +
                ')\n      scale(' +
                positioner.getScale() +
                ', ' +
                -1 * positioner.getScale() +
                ')\n    '
            ).replace(/\s+/g, ' '),
          };
        };
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      HanziWriterRenderer.prototype.mount = function(canvas) {
        ...
        svg.attr(
          ...
          'transform',
          '\n    translate(' +
            this._positioner.getXOffset() +
            ', ' +
            (this._positioner.getHeight() - this._positioner.getYOffset()) +
            ')\n    scale(' +
            this._positioner.getScale() +
            ', ' +
            -1 * this._positioner.getScale() +
            ')\n  '
        );
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      StrokeRenderer.prototype.mount = function(canvas) {
        ...
        var extendedMaskPoints = extendStart(
        ...
        svg.attr(
          this._animationPath,
          'd',
          svg.getPathString(extendedMaskPoints)
        );
        ...
        this._mutationChains.forEach(function(chain) {
          chain._scopes.forEach(function(chainScope) {
            scopes.forEach(function(scope) {
              if (
                chainScope.indexOf(scope) >= 0 ||
                scope.indexOf(chainScope) >= 0
              ) {
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var startAndEndMatches = function startAndEndMatches(
        points,
        closestStroke,
        leniency
      ) {
        var startingDist = distance(
          closestStroke.getStartingPoint(),
          points[0]
        );
        var endingDist = distance(
      ...
      var getMatchData = function getMatchData(points, stroke, options) {
        var _options$leniency = options.leniency,
          ...
          isOutlineVisible =
            _options$isOutlineVis === undefined ? false : _options$isOutlineVis;

        var avgDist = stroke.getAverageDistance(points);
        var distMod = isOutlineVisible || stroke.strokeNum > 0 ? 0.5 : 1;
        var withinDistThresh =
          avgDist <= AVG_DIST_THRESHOLD * distMod * leniency;
      ...
      var strokeMatches = function strokeMatches(
        userStroke,
        character,
        strokeNum
      ) {
        ...
        var strokeMatchData = getMatchData(
          points,
        ...
        for (var i = 0; i < laterStrokes.length; i++) {
          ...
          if (
            laterMatchData.isMatch &&
            laterMatchData.avgDist < closestMatchDist
          ) {
        ...
        if (closestMatchDist < strokeMatchData.avgDist) {
          ...
          var adjustedStrokeMatchData = getMatchData(
            points,
            character.strokes[strokeNum],
            adjustedOptions
          );
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var highlightStroke = function highlightStroke(stroke, color, speed) {
        ...
        return [
          ...
          new Mutation(
            'character.highlight.strokes.' + strokeNum + '.opacity',
            0,
            { duration: duration }
          ),
        ];
      ...
      var highlightCompleteChar = function highlightCompleteChar(
        character,
        color,
        duration
      ) {
