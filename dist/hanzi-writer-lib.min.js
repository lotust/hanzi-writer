...
module.exports = (function(t) {
  ...
  function(t, i, n) {
    ...
    (function(i) {
      ...
      (h.prototype.createSubCanvas = function() {
        var t = o('g');
        return this.svg.appendChild(t), new h(t, this.defs);
      }),
        (h.init = function(t) {
          var n =
            ...
            s = void 0,
            u = t;
          'string' == typeof t && (u = i.this.refs.t.current);
          var a = u.nodeName.toUpperCase();
          'SVG' === a || 'G' === a
            ? (s = u)
            : ((s = o('svg')), u.appendChild(s)),
            e(s, { width: n, height: r });
          var c = o('defs');
          return s.appendChild(c), new h(s, c);
        }),
        (t.exports = {
          createElm: o,
          attrs: e,
  ...
  function(t, i, n) {
        ...
        return (
          t.slice(1).forEach(function(t) {
            var r = n[n.length - 1],
              o = u(t, r);
            if (o > i)
              for (var s = Math.ceil(o / i), e = o / s, h = 0; h < s; h++)
                n.push(a(t, r, -1 * e * (h + 1)));
            else n.push(t);
          }),
          n
        );
    ...
    t.exports = {
          ...
          return n[o][s] > -1
            ...
            : ((n[o][s] =
                0 === o && 0 === s
                  ? u(t[0], i[0])
                  : o > 0 && 0 === s
                  ? Math.max(r(o - 1, 0), u(t[o], i[0]))
                  : 0 === o && s > 0
                  ? Math.max(r(0, s - 1), u(t[0], i[s]))
                  : o > 0 && s > 0
                  ? Math.max(
                      Math.min(r(o - 1, s), r(o - 1, s - 1), r(o, s - 1)),
                      u(t[o], i[s])
                    )
                  : 1 / 0),
              n[o][s]);
      ...
      cosineSimilarity: function(t, i) {
        return (t.x * i.x + t.y * i.y) / h(t) / h(i);
      },
      extendPointOnLine: a,
      filterParallelPoints: function(t) {
        ...
        var i = [t[0], t[1]];
        return (
          t.slice(2).forEach(function(t, n) {
            var r = i.length,
              o = e(t, i[r - 1]),
              s = e(i[r - 1], i[r - 2]);
      ...
      normalizeCurve: function(t) {
        var i = { x: o([t[0].x, s(t).x]), y: o([t[0].y, s(t).y]) },
          n = t.map(function(t) {
            return e(t, i);
          }),
          r = Math.sqrt(
            o([
              Math.pow(n[0].x, 2) + Math.pow(n[0].y, 2),
              Math.pow(s(n).x, 2) + Math.pow(s(n).y, 2),
            ])
          ),
          h = n.map(function(t) {
  ...
  function(t, i, n) {
    ...
    var r = n(5),
      ...
      s = function(t, i, n) {
        return [
          new r(
            'character.' + t + '.strokes',
            o({ opacity: 1, displayPortion: 1 }, i.strokes.length),
            { duration: n, force: !0 }
          ),
        ];
      },
      e = function(t, i, n) {
        return [
          new r('character.' + t + '.opacity', 0, { duration: n, force: !0 }),
        ].concat(s(t, i, 0));
      },
      h = function(t, i, n) {
        var o,
          ...
          e,
          h = i.strokeNum,
          u = (i.getLength() + 600) / (3 * n);
        return [
          new r('character.' + t, {
            opacity: 1,
            strokes: ((o = {}),
            (s = h),
            (e = { displayPortion: 0, opacity: 1 }),
            s in o
          ...
          new r('character.' + t + '.strokes.' + h + '.displayPortion', 1, {
            duration: u,
          }),
        ];
      },
      u = function(t, i, n, u, a) {
        var c = e(t, i, n);
        return (
          (c = c.concat(s(t, i, 0))).push(
            new r(
              'character.' + t,
              { opacity: 1, strokes: o({ opacity: 0 }, i.strokes.length) },
              { force: !0 }
            )
          ),
          i.strokes.forEach(function(i, n) {
            n > 0 && c.push(new r.Pause(a)), (c = c.concat(h(t, i, u)));
          }),
          c
        );
      };
    t.exports = {
      ...
      showCharacter: function(t, i, n) {
        return [
          new r(
            ...
            {
              opacity: 1,
              strokes: o({ opacity: 1, displayPortion: 1 }, i.strokes.length),
            },
            { duration: n, force: !0 }
          ),
        ];
      ...
      animateCharacterLoop: function(t, i, n, o, s, e) {
        var h = u(t, i, n, o, s);
        return h.push(new r.Pause(e)), h;
      },
      animateStroke: h,
      animateSingleStroke: function(t, i, n, o) {
        return [
          new r('character.' + t, function(n) {
            for (
              var r = n.character[t], o = { opacity: 1, strokes: {} }, s = 0;
              s < i.strokes.length;
              s++
            )
              o.strokes[s] = { opacity: r.opacity * r.strokes[s].opacity };
            return o;
          }),
        ].concat(h(t, i.strokes[n], o));
      },
      ...
      updateColor: function(t, i, n) {
        return [new r('options.' + t, i, { duration: n })];
      },
    };
  },
  function(t, i, n) {
    ...
    (u.prototype.run = function(t) {
      ...
      (u.prototype.w = function(t) {
        var i,
          n = Math.min(1, (t - this.P) / this.u);
        if (1 === n)
          this.S.updateState(this.k), (this.j = null), this.cancel(this.S);
        else {
      ...
      (u.prototype.M = function(t) {
        var i = this.h;
        'function' == typeof this.h && (i = this.h(t.state)),
          (this.k = o(this.scope, i));
      }),
      (u.prototype.cancel = function(t) {
        this.F && this.F(),
          ...
          this.j && h(this.j),
          (this.j = null),
          this.f && (this.k || this.M(t), t.updateState(this.k));
      }),
      ...
      (g.prototype.showCharacter = function() {
            ...
            this.A(function() {
              return t.S.run(
                f.animateCharacter(
                  ...
                  t.U,
                  t.I.strokeFadeDuration,
                  t.I.strokeAnimationSpeed,
                  t.I.delayBetweenStrokes
                )
              ).then(function(t) {
                return d(i.onComplete, t);
              });
        ...
        (g.prototype.animateStroke = function(t) {
          ...
          return (
            ...
            this.A(function() {
              return i.S.run(
                f.animateSingleStroke('main', i.U, t, i.I.strokeAnimationSpeed)
              ).then(function(t) {
          ...
          return this.A(function() {
            var o =
                'number' == typeof r.duration
                  ? r.duration
                  : n.I.strokeFadeDuration,
              s = i;
            'radicalColor' !== t || i || (s = n.I.strokeColor);
            var e = y(s);
            n.I[t] = i;
            var h = f.updateColor(t, e, o);
            return (
              'radicalColor' !== t ||
                i ||
                (h = h.concat(f.updateColor(t, null, 0))),
              n.S.run(h).then(function(t) {
        ...
        (g.prototype.quiz = function() {
          ...
          this.A(function() {
            t.cancelQuiz(),
              (t.L = new h(t.U, t.S, t.T)),
              t.L.startQuiz(v({}, t.I, i));
          });
        }),
        ...
        (g.prototype.setCharacter = function(t) {
          ...
          return (
            this.cancelQuiz(),
            (this.W = t),
            this._ && this._.destroy(),
            this.S && this.S.cancelAll(),
            (this._ = null),
            (this.z = this.H.loadCharData(t).then(function(n) {
              if (!i.H.loadingFailed) {
                var h = new s();
                (i.U = h.generateCharacter(t, n)),
                  (i.T = new e(i.I)),
                  (i._ = new r(i.U, i.T)),
                  (i.S = new o(i.U, i.I, function(t) {
                    i._.render(t);
                  })),
                  i._.mount(i.G, i.S.state),
                  i._.render(i.S.state);
              }
            })),
            this.z
          );
        ...
        (g.prototype.D = function(t, i) {
          return (
            (this.G = u.Canvas.init(t, i.width, i.height)),
            this.G.svg.createSVGPoint && (this.N = this.G.svg.createSVGPoint()),
            (this.I = this.R(i)),
            (this.H = new c(this.I)),
            this.q(),
            (this.L = null),
        ...
        (g.prototype.q = function() {
          ...
          this.G.svg.addEventListener('mousedown', function(i) {
            !t.isLoadingCharData &&
              t.L &&
              (i.preventDefault(), t.V('startUserStroke', t.$(i)));
          }),
            this.G.svg.addEventListener('touchstart', function(i) {
              !t.isLoadingCharData &&
                t.L &&
                (i.preventDefault(), t.V('startUserStroke', t.J(i)));
            }),
            this.G.svg.addEventListener('mousemove', function(i) {
              !t.isLoadingCharData &&
                t.L &&
                (i.preventDefault(), t.V('continueUserStroke', t.$(i)));
            }),
            this.G.svg.addEventListener('touchmove', function(i) {
              !t.isLoadingCharData &&
                t.L &&
                (i.preventDefault(), t.V('continueUserStroke', t.J(i)));
            }),
        ...
        (g.prototype.J = function(t) {
          if (this.N) {
            (this.N.x = t.touches[0].clientX),
              (this.N.y = t.touches[0].clientY);
            var i = this.N.matrixTransform(this.G.svg.getScreenCTM().inverse());
            return { x: i.x, y: i.y };
          }
          var n = this.G.svg.getBoundingClientRect();
    ...
    (h.prototype.mount = function(t) {
      ...
      e.attr(
        ...
        '\n    translate(' +
          this.T.getXOffset() +
          ', ' +
          (this.T.getHeight() - this.T.getYOffset()) +
          ')\n    scale(' +
          this.T.getScale() +
          ', ' +
          -1 * this.T.getScale() +
          ...
          Object.keys(n).forEach(function(r) {
            if (n[r]) {
              var e = s(
                ...
                h = i.X[r];
              h || ((h = new o()).mount(i.Y, e), (i.X[r] = h)), h.render(e);
            }
          });
      }),
  ...
  function(t, i, n) {
    ...
    function o(t) {
      (this.tt = {}),
        (this.character = t),
        (this.strokeRenderers = this.character.strokes.map(function(t) {
          return new r(t);
        }));
    }
    (o.prototype.mount = function(t) {
      var i = t.createSubCanvas();
      (this.it = i.svg),
        this.strokeRenderers.forEach(function(t, n) {
          t.mount(i);
        });
    }),
      (o.prototype.render = function(t) {
        if (t !== this.tt) {
          t.opacity !== this.tt.opacity &&
            ((this.it.style.opacity = t.opacity),
            0 === t.opacity
              ? (this.it.style.display = 'none')
              : 0 === this.tt.opacity && (this.it.style.display = 'initial'));
          var i =
            !this.tt ||
            t.strokeColor !== this.tt.strokeColor ||
            t.radicalColor !== this.tt.radicalColor;
          if (i || t.strokes !== this.tt.strokes)
            for (var n = 0; n < this.strokeRenderers.length; n++)
              (!i && this.tt.strokes && t.strokes[n] === this.tt.strokes[n]) ||
                this.strokeRenderers[n].render({
  ...
  function(t, i, n) {
    ...
    var r = n(0).counter,
      ...
      h = s.filterParallelPoints,
      u = 200;
    function a(t) {
      (this.tt = {}), (this.nt = t), (this.rt = t.getLength() + u / 2);
    }
    (a.prototype.mount = function(t) {
      (this.ot = o.createElm('path')),
        (this.st = o.createElm('clipPath')),
        (this.et = o.createElm('path'));
      var i = 'mask-' + r();
      o.attr(this.st, 'id', i),
        o.attr(this.et, 'd', this.nt.path),
        (this.ot.style.opacity = 0),
        o.attr(this.ot, 'clip-path', 'url(#' + i + ')');
      var n = (function(t, i) {
      ...
      })(h(this.nt.points), u / 2);
      return (
        o.attr(this.ot, 'd', o.getPathString(n)),
        o.attrs(this.ot, {
          stroke: '#FFFFFF',
          'stroke-width': u,
          fill: 'none',
        ...
        t.defs.appendChild(this.st),
        t.svg.appendChild(this.ot),
        this
      );
    }),
      (a.prototype.render = function(t) {
        if (t !== this.tt) {
          t.displayPortion !== this.tt.displayPortion &&
            (this.ot.style.strokeDashoffset = this.ht(t.displayPortion));
          var i = this.ut(t);
          if (i !== this.ut(this.tt)) {
            var n = i.r,
              r = i.g,
              s = i.b,
              e = i.a;
          ...
          t.opacity !== this.tt.opacity && (this.ot.style.opacity = t.opacity),
            (this.tt = t);
        }
      }),
      (a.prototype.ht = function(t) {
        return 0.999 * this.rt * (1 - t);
      }),
    ...
    (o.prototype.mount = function(t) {
      ...
      (o.prototype.render = function(t) {
        if (t !== this.tt) {
          if (
            t.strokeColor !== this.tt.strokeColor ||
            t.strokeWidth !== this.tt.strokeWidth
          ) {
            var i = t.strokeColor,
              n = i.r,
              o = i.g,
          ...
          t.opacity !== this.tt.opacity &&
            r.attr(this.at, 'opacity', t.opacity),
            t.points !== this.tt.points &&
              r.attr(this.at, 'd', r.getPathString(t.points)),
            (this.tt = t);
        }
      }),
    ...
    (e.prototype.updateState = function(t) {
      ...
      (e.prototype.run = function(t) {
        ...
        return (
          ...
          new Promise(function(o) {
            var s = { lt: !0, vt: 0, F: o, dt: t, pt: n.loop, yt: r };
            i.ft.push(s), i.wt(s);
          })
        );
      }),
      (e.prototype.wt = function(t) {
        ...
        if (t.lt) {
          ...
          t.dt[t.vt].run(this).then(function() {
            t.lt && (t.vt++, i.wt(t));
          });
        }
      }),
      ...
      (e.prototype.gt = function(t) {
        t.lt = !1;
        for (var i = t.vt; i < t.dt.length; i++) t.dt[i].cancel(this);
        t.F && t.F({ canceled: !0 }),
          (this.ft = this.ft.filter(function(i) {
            return i !== t;
          }));
      ...
      (e.prototype.generateStrokes = function(t) {
        return t.strokes.map(function(i, n) {
          ...
          return new o(
            ...
            e,
            n,
            ((s = n), t.radStrokes && t.radStrokes.indexOf(s) >= 0)
          );
        });
      }),
      (t.exports = e);
  ...
  function(t, i, n) {
    ...
    (h.prototype.getStartingPoint = function() {
      return this.points[0];
    }),
      (h.prototype.getEndingPoint = function() {
        return this.points[this.points.length - 1];
      }),
      (h.prototype.getLength = function() {
        return e(this.points);
      }),
      (h.prototype.getVectors = function() {
        var t = this.points[0];
      ...
      (h.prototype.getDistance = function(t) {
        var i = this.points.map(function(i) {
          return s(i, t);
        });
        return Math.min.apply(Math, i);
      }),
      (h.prototype.getAverageDistance = function(t) {
        var i = this;
        return (
  ...
  function(t, i, n) {
    ...
    (o.prototype.convertExternalPoint = function(t) {
      return {
        ...
        y: (this.getHeight() - this.Mt - t.y) / this.bt,
      };
    }),
      ...
      (o.prototype.mt = function() {
        var t = r,
          i = t[1].x - t[0].x,
          n = t[1].y - t[0].y,
          o = this.I.width - 2 * this.I.padding,
          s = this.I.height - 2 * this.I.padding,
          e = o / i,
          h = s / n;
        this.bt = Math.min(e, h);
        var u = this.I.padding + (o - this.bt * i) / 2,
          a = this.I.padding + (s - this.bt * n) / 2;
        (this.kt = -1 * t[0].x * this.bt + u),
          (this.Mt = -1 * t[0].y * this.bt + a);
      }),
      (t.exports = o);
  },
  function(t, i, n) {
    ...
    function v(t, i, n) {
      (this.U = t), (this.S = i), (this.lt = !1), (this.T = n);
    }
    (v.prototype.startQuiz = function(t) {
      (this.lt = !0),
        ...
        (this.Pt = 0),
        (this.jt = []),
        this.S.run(u.startQuiz(this.U, t.strokeFadeDuration));
    }),
      (v.prototype.startUserStroke = function(t) {
        var i = this.T.convertExternalPoint(t);
        if (!this.lt) return null;
        if (this.xt) return this.endUserStroke();
        var n = h();
        (this.xt = new o(n, i, t)), this.S.run(u.startUserStroke(n, i));
      }),
      (v.prototype.continueUserStroke = function(t) {
        if (this.xt) {
          ...
          this.S.run(u.updateUserStroke(this.xt.id, n));
        }
      }),
      (v.prototype.endUserStroke = function() {
        if (this.xt)
          if (
            (this.S.run(
              u.removeUserStroke(this.xt.id, this.I.drawingFadeDuration)
            ),
            1 !== this.xt.points.length)
          ) {
            var t = this.Ft(),
              i = this.S.state.character.outline.opacity > 0;
            r(this.xt, this.U, this.St, {
              isOutlineVisible: i,
              leniency: this.I.leniency,
            })
              ? this.Ot(t)
              : (this.Dt(),
                this.Ct >= this.I.showHintAfterMisses &&
                  this.S.run(
                    u.highlightStroke(
                      t,
                      this.I.highlightColor,
                      this.I.strokeHighlightSpeed
                    )
                  )),
              (this.xt = null);
          } else this.xt = null;
      ...
      (v.prototype.Ot = function(t) {
        e(this.I.onCorrectStroke, {
          character: this.U.symbol,
          strokeNum: this.St,
          mistakesOnStroke: this.Ct,
          totalMistakes: this.Pt,
          strokesRemaining: this.U.strokes.length - this.St - 1,
          drawnPath: l(this.xt),
        });
        var i = f.showStroke('main', this.St, this.I.strokeFadeDuration);
        (this.St += 1),
          (this.Ct = 0),
          this.St === this.U.strokes.length &&
            ((this.lt = !1),
            e(this.I.onComplete, {
              character: this.U.symbol,
              totalMistakes: this.Pt,
            }),
            this.I.highlightOnComplete &&
              (i = i.concat(
                u.highlightCompleteChar(
                  this.U,
                  this.I.highlightCompleteColor,
                  2 * this.I.strokeHighlightDuration
                )
              ))),
          this.S.run(i);
      }),
      (v.prototype.Dt = function() {
        (this.Ct += 1),
          ...
          e(this.I.onMistake, {
            ...
            mistakesOnStroke: this.Ct,
            totalMistakes: this.Pt,
            strokesRemaining: this.U.strokes.length - this.St,
            drawnPath: l(this.xt),
          });
      }),
      (v.prototype.Ft = function() {
        return this.U.strokes[this.St];
      }),
      (t.exports = v);
  },
  function(t, i, n) {
    ...
    var r = n(0),
      ...
      w = function(t, i, n) {
        var r = n.leniency,
          ...
          e = void 0 !== s && s,
          h = i.getAverageDistance(t),
          u = h <= 350 * (e || i.strokeNum > 0 ? 0.5 : 1) * o;
        if (!u) return { isMatch: !1, avgDist: h };
        var f,
          w,
          g,
          m,
          ...
          F = ((f = t),
          (g = o),
          (m = c((w = i).getStartingPoint(), f[0])),
          (k = c(w.getEndingPoint(), f[f.length - 1])),
          m <= 250 * g && k <= 250 * g),
          O = p(t, i),
          D = ((b = t),
          (M = i.points),
          ...
          j <= 0.75 * S),
          A = ((x = i), (o * (d(t) + 25)) / (x.getLength() + 25) >= 0.35);
        return { isMatch: u && F && O && D && A, avgDist: h };
      };
    t.exports = function(t, i, n) {
      ...
      for (
        var h = i.strokes.slice(n + 1), a = e.avgDist, c = 0;
        c < h.length;
        c++
      ) {
        var f = w(o, h[c], r);
      ...
      if (a < e.avgDist) {
        var l = (0.6 * (a + e.avgDist)) / (2 * e.avgDist),
          v = (r.leniency || 1) * l,
          d = s({}, r, { leniency: v });
    ...
    t.exports = {
      ...
      highlightStroke: function(t, i, n) {
        var o,
          ...
          e,
          h = t.strokeNum,
          u = (t.getLength() + 600) / (3 * n);
        return [
          new r('character.highlight.strokeColor', i),
          new r('character.highlight', {
            opacity: 1,
            strokes: ((o = {}),
            (s = h),
            (e = { displayPortion: 0, opacity: 0 }),
            s in o
              ? Object.defineProperty(o, s, {
                  value: e,
                  enumerable: !0,
          ...
          new r(
            'character.highlight.strokes.' + h,
            { displayPortion: 1, opacity: 1 },
            { duration: u }
          ),
          new r('character.highlight.strokes.' + h + '.opacity', 0, {
            duration: u,
          }),
        ];
      },
  ...
  function(t, i, n) {
    ...
    (o.prototype.It = function(t, i) {
      var n = this,
        ...
        o = this.I.charDataLoader(t, r, function(t) {
          i === n.At && n.Lt(t);
        });
      o && r(o);
    }),
      (o.prototype.Tt = function() {
        ...
        this.Et = new Promise(function(i, n) {
          ...
          function(i) {
            return (t.Ut = !1), r(t.I.onLoadCharDataSuccess, i), i;
          },
          function(i) {
            if (
              ((t.Ut = !1),
              (t.loadingFailed = !0),
              r(t.I.onLoadCharDataError, i),
              !t.I.onLoadCharDataError)
            ) {
